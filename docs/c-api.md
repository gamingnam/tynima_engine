<!-- Generated by tools/gen_docs.py from sdk/include/tynima.h. Do not edit: change
...
| name | value | |
| --- | --- | --- |
| `TYNIMA_API_VERSION` | `10u` |  |
| `TYNIMA_API_VERSION_MIN` | `1u` | The oldest a game module may have been built against and still load. |
| `TYNIMA_NO_COMPONENT` | `0xFFFFFFFFu` |  |
| `TYNIMA_MAX_COMPONENT_TYPES` | `64u` |  |
| `TYNIMA_FIELD_READ_ONLY` | `1u` | shown, never edited |
| `TYNIMA_FIELD_HIDDEN` | `2u` | an implementation detail: not shown |
| `TYNIMA_MAX_COMPONENT_FIELDS` | `64u` |  |
...
| `TYNIMA_NAME_CAPACITY` | `32u` | What an entity is called, for people. NUL-terminated; longer names are cut. |
| `TYNIMA_MAX_LIGHTS` | `256u` |  |
| `TYNIMA_GAME_ENTRY_NAME` | `"tynima_game_entry"` |  |
| `TYNIMA_NO_MODEL` | `0xFFFFFFFFu` |  |
| `TYNIMA_DEBUG_VIEW_COUNT` | `8u` | 0 is the lit picture; the rest show one quantity |
| `TYNIMA_LOG_RING` | `2048u` |  |
| `TYNIMA_LOG_CATEGORY_MAX` | `24u` |  |
| `TYNIMA_LOG_MESSAGE_MAX` | `224u` |  |

## Index

**engine version** — [`tynima_version`](#tynima_version), [`tynima_get_version`](#tynima_get_version), [`tynima_get_version_string`](#tynima_get_version_string)

**math** — [`tynima_vec3`](#tynima_vec3), [`tynima_vec4`](#tynima_vec4), [`tynima_quat`](#tynima_quat), [`tynima_mat4`](#tynima_mat4)

**a little math, inline, for hosts and modules written in C** — [`tynima_vec3_make`](#tynima_vec3_make), [`tynima_vec3_add`](#tynima_vec3_add), [`tynima_vec3_sub`](#tynima_vec3_sub), [`tynima_vec3_scale`](#tynima_vec3_scale), [`tynima_vec3_dot`](#tynima_vec3_dot), [`tynima_vec3_cross`](#tynima_vec3_cross), [`tynima_vec3_length`](#tynima_vec3_length), [`tynima_vec3_normalize`](#tynima_vec3_normalize), [`tynima_quat_identity`](#tynima_quat_identity), [`tynima_quat_from_axis_angle`](#tynima_quat_from_axis_angle), [`tynima_quat_mul`](#tynima_quat_mul), [`tynima_quat_normalize`](#tynima_quat_normalize), [`tynima_quat_rotate`](#tynima_quat_rotate), [`tynima_quat_from_euler`](#tynima_quat_from_euler), [`tynima_quat_to_euler`](#tynima_quat_to_euler)

**world** — [`tynima_entity`](#tynima_entity), [`tynima_component_id`](#tynima_component_id), [`tynima_component_info`](#tynima_component_info), [`tynima_field_kind`](#tynima_field_kind), [`tynima_field`](#tynima_field), [`tynima_chunk_fn`](#tynima_chunk_fn)

**the built-in components, as C sees them** — [`tynima_name`](#tynima_name), [`tynima_transform`](#tynima_transform), [`tynima_local_to_world`](#tynima_local_to_world), [`tynima_parent`](#tynima_parent), [`tynima_mesh_renderer`](#tynima_mesh_renderer), [`tynima_body`](#tynima_body), [`tynima_rigid_body`](#tynima_rigid_body)

**input** — [`tynima_key`](#tynima_key), [`tynima_mouse_button`](#tynima_mouse_button)

**logging** — [`tynima_log_level`](#tynima_log_level)

**what a game sets up: the view, the light, the shapes** — [`tynima_camera`](#tynima_camera), [`tynima_lighting`](#tynima_lighting), [`tynima_point_light`](#tynima_point_light), [`tynima_shape_type`](#tynima_shape_type), [`tynima_shape`](#tynima_shape), [`tynima_shape_box`](#tynima_shape_box), [`tynima_shape_sphere`](#tynima_shape_sphere), [`tynima_shape_capsule`](#tynima_shape_capsule), [`tynima_motion`](#tynima_motion), [`tynima_body_desc`](#tynima_body_desc), [`tynima_body_desc_make`](#tynima_body_desc_make), [`tynima_ray_hit`](#tynima_ray_hit)

**the API a game module receives** — [`tynima_engine`](#tynima_engine), [`tynima_api`](#tynima_api)

**what a game module exports** — [`tynima_game`](#tynima_game)

**the engine** — [`tynima_engine_desc`](#tynima_engine_desc), [`tynima_engine_create`](#tynima_engine_create), [`tynima_engine_destroy`](#tynima_engine_destroy), [`tynima_last_error`](#tynima_last_error), [`tynima_engine_api`](#tynima_engine_api), [`tynima_engine_begin_frame`](#tynima_engine_begin_frame), [`tynima_engine_end_frame`](#tynima_engine_end_frame), [`tynima_engine_dt`](#tynima_engine_dt), [`tynima_engine_time`](#tynima_engine_time), [`tynima_engine_frame_index`](#tynima_engine_frame_index)

**models** — [`tynima_load_model`](#tynima_load_model), [`tynima_model_count`](#tynima_model_count), [`tynima_cook_model`](#tynima_cook_model), [`tynima_model_bounds`](#tynima_model_bounds)

**picking** — [`tynima_pick`](#tynima_pick)

**scenes** — [`tynima_save_scene`](#tynima_save_scene), [`tynima_load_scene`](#tynima_load_scene), [`tynima_clear_scene`](#tynima_clear_scene)

**the view** — [`tynima_get_camera`](#tynima_get_camera), [`tynima_set_camera`](#tynima_set_camera), [`tynima_get_lighting`](#tynima_get_lighting), [`tynima_set_lighting`](#tynima_set_lighting), [`tynima_shading_path`](#tynima_shading_path), [`tynima_shading_model`](#tynima_shading_model), [`tynima_tonemap`](#tynima_tonemap), [`tynima_anti_aliasing`](#tynima_anti_aliasing), [`tynima_render_settings`](#tynima_render_settings), [`tynima_get_render_settings`](#tynima_get_render_settings), [`tynima_set_render_settings`](#tynima_set_render_settings), [`tynima_debug_view_name`](#tynima_debug_view_name)

**the UI** — [`tynima_ui_context`](#tynima_ui_context), [`tynima_ui_scene_texture`](#tynima_ui_scene_texture), [`tynima_ui_pixel_density`](#tynima_ui_pixel_density), [`tynima_ui_wants_mouse`](#tynima_ui_wants_mouse), [`tynima_ui_wants_keyboard`](#tynima_ui_wants_keyboard), [`tynima_set_relative_mouse`](#tynima_set_relative_mouse)

**the log, as a console reads it** — [`tynima_log_entry`](#tynima_log_entry), [`tynima_log_count`](#tynima_log_count), [`tynima_log_get`](#tynima_log_get), [`tynima_log_level_get`](#tynima_log_level_get), [`tynima_log_level_set`](#tynima_log_level_set)

**statistics** — [`tynima_stats`](#tynima_stats), [`tynima_get_stats`](#tynima_get_stats)

**the camera, inline: the same projection the engine draws with** — [`tynima_camera_ray`](#tynima_camera_ray), [`tynima_camera_project`](#tynima_camera_project)
...
```c
typedef struct tynima_api { ... } tynima_api;
```

##### `version`

TYNIMA_API_VERSION of the host
